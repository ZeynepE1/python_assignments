password = "123Zeynep" #  sabit olan şifres
name = ('Zeynep', 'zeynep', 'ZEYNEP') # Kendi ismim. Büyük ve küçük harf kullanılabileceği için tuple kullandım. Tuple kullanarak değişmez yaptım.
